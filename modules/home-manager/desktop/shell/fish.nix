...
let
  cfg = config.homeManagerModules.desktop.shell.fish;
  toolsCfg = config.homeManagerModules.desktop.shell.tools or { };
  aliases = config.homeManagerModules.desktop.shell._aliases or { };
in
{
  options.homeManagerModules.desktop.shell = {
    _aliases = mkOption {
  ...
  options.homeManagerModules.desktop.shell.fish = {
